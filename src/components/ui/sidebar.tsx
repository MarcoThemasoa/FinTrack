  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 relative max-h-svh w-[--sidebar-width] bg-transparent transition-[width] ease-linear", // Changed h-svh to max-h-svh
        ...
        <div
          className={cn(
            "duration-200 fixed top-0 z-10 hidden max-h-svh w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex", // Changed inset-y-0 to top-0, h-svh to max-h-svh
            side === "left"
